        ...
        <div className=' flex flex-wrap'>
            <div className='w-full lg:w-1/2'>
                <div className='flex flex-col items-center lg:items-start'>
                    ...
                    initial="hidden"
                    animate="visible"
                    className='pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-8xl'>Fagoon Sharma</motion.h1>
                    <motion.span 
            ...
            <div className='w-full lg:w-1/2 lg:p-8'>
                <motion.div 
                  ...
                  className='flex justify-center'><img className="h-[25rem] w-[25rem] rounded-3xl pl-4" src={hero}></img></motion.div>
            </div>
